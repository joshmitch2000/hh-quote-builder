(()=>{function u(){let o=document.getElementById("form"),a=!!window.elementor;if(window.HHQuoteNav=(function(){function i(){return o==null?void 0:o.querySelector(".e-form__step:not(.elementor-hidden)")}function n(){var s;(s=document.getElementById("package_quote_form"))==null||s.scrollIntoView({block:"center",behavior:"smooth"})}function l(){var s,r;(r=(s=i())==null?void 0:s.querySelector(".e-form__buttons__wrapper__button-next"))==null||r.click(),n()}return{afterPackageSelect(s){a||(l(),s===0&&l())}}})(),a)return;o==null||o.addEventListener("click",i=>{let n=i.target.closest(".e-form__buttons__wrapper__button-previous");n&&requestAnimationFrame(()=>{var r,d,c;let l=(c=(d=(r=Alpine.store("quote"))==null?void 0:r.selectedPackage)==null?void 0:d.addons)!=null?c:[],s=document.querySelector(".elementor-field-group-addons:not(.elementor-hidden)");l.length===0&&s&&n.click()})});function e(){var n;let i=!((n=o==null?void 0:o.querySelector(".elementor-field-group-package"))!=null&&n.classList.contains("elementor-hidden"));document.querySelectorAll(".js-step1-only").forEach(l=>{l.style.display=i?"":"none"})}let t=document.querySelector(".elementor-form-fields-wrapper");t&&new MutationObserver(e).observe(t,{attributes:!0,attributeFilter:["class"],subtree:!0}),e()}function p(){document.addEventListener("alpine:init",()=>{let o=document.getElementById("hh-quote-data");if(!o){console.error("[HH Quote Builder] #hh-quote-data payload not found.");return}let a;try{a=JSON.parse(o.textContent)}catch(e){console.error("[HH Quote Builder] Failed to parse quote data:",e);return}Alpine.store("quote",{packages:a.packages,coverageChoices:a.coverageChoices,styleChoices:a.styleChoices,availableCoverage:a.availableCoverage,styleToCoverages:a.styleToCoverages,coverage:a.defaultCoverage,style:null,selectedPackage:null,addonState:{},get availableCoverageList(){return this.availableCoverage.map(e=>({slug:e,label:this.coverageChoices[e]}))},get styleList(){return Object.keys(this.styleToCoverages).map(e=>({slug:e,label:this.styleChoices[e],isValid:this.coverage?this.styleToCoverages[e].includes(this.coverage):!1}))},get coverageLabel(){return this.coverageChoices[this.coverage]||""},get styleLabel(){return this.styleChoices[this.style]||""},get visiblePackages(){return!this.coverage||!this.style?[]:this.packages.filter(e=>e.coverage===this.coverage&&e.style===this.style)},get total(){if(!this.selectedPackage)return 0;let e=this.selectedPackage.price;for(let t of this.selectedPackage.addons){let i=this.addonState[t.id];if(!(i!=null&&i.checked))continue;let n=t.type==="quantity"?Number(i.qty||0):1;t.type==="quantity"&&!n||(e+=t.price*n)}return e},get addonSummaryLines(){return this.selectedPackage?this.selectedPackage.addons.filter(e=>{var t;return(t=this.addonState[e.id])==null?void 0:t.checked}).map(e=>{let t=e.type==="quantity"?Number(this.addonState[e.id].qty||0):1;return e.type==="quantity"&&!t?null:{id:e.id,text:`${t>1?t+" ":""}${e.label} + $${this.formatNumber(e.price*t)}`}}).filter(Boolean):[]},get hasSelectedAddons(){return this.addonSummaryLines.length>0},formatNumber(e){return Number(e||0).toLocaleString("en-US")},selectPackage(e){this.selectedPackage=e,this.addonState=Object.fromEntries(e.addons.map(t=>[t.id,{checked:!1,qty:null}])),Alpine.nextTick(()=>window.HHQuoteNav.afterPackageSelect(e.addons.length))}}),Alpine.effect(()=>{let e=Alpine.store("quote");e.style&&!e.styleList.find(t=>t.slug===e.style&&t.isValid)&&(e.style=null)})})}function m(){let o={selected_coverage:()=>Alpine.store("quote").coverage||"",selected_style:()=>Alpine.store("quote").style||"",package_name:()=>{var a;return((a=Alpine.store("quote").selectedPackage)==null?void 0:a.label)||""},base_price:()=>{var a,e;return(e=(a=Alpine.store("quote").selectedPackage)==null?void 0:a.price)!=null?e:""},estimated_total:()=>Alpine.store("quote").selectedPackage?Alpine.store("quote").total:"",selected_addons_summary:()=>Alpine.store("quote").addonSummaryLines.map(a=>a.text).join(", ")};document.addEventListener("alpine:init",()=>{for(let a of Object.keys(o))document.querySelector(`input[name="form_fields[${a}]"]`)||console.warn(`[HH Quote Builder] Missing Elementor hidden field: form_fields[${a}]. Quote submissions will be incomplete until this field exists in the form.`);Alpine.effect(()=>{for(let[a,e]of Object.entries(o)){let t=document.querySelector(`input[name="form_fields[${a}]"]`);t&&(t.value=e())}})})}function f(){let o=null;function a(){let e=document.getElementById("cards-container");e&&!e.hasChildNodes()&&(e.innerHTML=`
        ...
        `,Alpine.initTree(t));let i=document.getElementById("selection-summary");i&&!i.hasChildNodes()&&(i.innerHTML=`
            ...
            `,Alpine.initTree(i))}document.addEventListener("alpine:initialized",()=>{if(a(),o)return;let e=!1;o=new MutationObserver(()=>{if(!e){e=!0;try{a()}finally{e=!1}}});for(let t of["cards-container","addons-container","selection-summary"]){let i=document.getElementById(t);i&&o.observe(i,{childList:!0})}})}var y={nav:u,store:p,bridge:m,inject:f};for(let[o,a]of Object.entries(y))try{a()}catch(e){console.error(`[HH Quote Builder] Section "${o}" failed:`,e)}})();
